...
import blackUser from "../../assets/icons8-customer-50.png";
...
function Profile() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Insert product data
    await API.patch("/profile", formData, config).then((res) => console.log(res)).catch((err) => console.log(err))
        ...
        <Row className={cssModule.myBooks}>
          {dtlBook.map((item, index) => (
            ...
            >
              ...
              <a href={item.book.bookPdf} target="_blank">
                Download
              </a>
            </Col>
          ))}
